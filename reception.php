...
<head>
	...
	<title>Santi Dashboard (Reception)</title>
</head>
<body>
<div class="parent">
	<div class="" id="mySidebar">
	 ...
	 <ul>
		<l1><h1><a href="reception.php" style="text-decoration: none;">Santi Health<a></a></h1></l1>
	...
	<header id="myNavbar">
		<img src="includes/images/white.JPG" alt="" width="10%">
		<a href="logout.php">Logout</a>
		<a href="">Notifications</a>
	<select>
		<option selected class="profile-selection"><b><?php echo $profile ?></b></option>
		<option><button onclick="pharmacies()">Update profile</button></option>
		<option>Change password</option>
	</select>
	<button onclick="darkmode()" class="theme-toggle"></button>
	</header>
		<main id="main_content">
			<h1><?php echo $greet.' ' .$name.', '; ?>what would you like to do😊.</h1>
